  ...
  namespace control{
    ...
    namespace auton{
      ...
      void turnEnc(double deg,int v,int endwait){
        ...
        // double ZActual=(-front_left_motor.getPosition()+front_right_motor.getPosition()-back_left_motor.getPosition()+back_right_motor.getPosition())*(WheelCir/92)*180/M_PI; //what the robots currant z is
